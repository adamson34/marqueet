...
- [ ] Weather in the ticker: an LED weather segment (LED icons in the font data), with its own admin toggle; rain/snow heads-up (ticker first: every source gets a ticker presence)
